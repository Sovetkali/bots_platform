...
- **Фильтры и Middleware** - Гибкая обработка сообщений и исключение ботов
...
- **Filters** ([`filters/`](filters/)) - Фильтры для обработки сообщений
- **Middlewares** ([`middlewares/`](middlewares/)) - Middleware для обработки запросов
...
# Middleware для исключения ботов
